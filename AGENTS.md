...
| Layer | Technology |
|-------|------------|
| Base image | `ghcr.io/home-assistant/{amd64,aarch64}-base:3.24` (Alpine Linux) |
| Proxy | HAProxy 3.4.3-r0 (pinned Alpine package) |
...
- Pin package versions exactly: `apk add --no-cache haproxy=3.4.3-r0`.
